<?php 
    ...
    $data_news = count($data_get_news_page['news']);
    if ($data_news >0) {
     ...
     ?>
        <li>
            <div class="list_inner">
                 <div class="" style="height: 200px; background-repeat: no-repeat; background-size: cover; background-image: url(<?php echo $back_root; ?>upload_file/news/<?php echo $news['news_folder']; ?>/image_news.png) ;">
                 ...
                 <div class="details" style="height: 250px;">
                     <div class="extra">
                         ...
                         <!--
                         <div class="my_like">
                             <a href="#"><img class="svg" src="assets/img/svg/like.svg" alt="" /><span>16</span></a>
                         </div>
                        -->
                     </div>
                      <h3 class="title">
...
<!-- <a class="page-numbers current" onclick="news_load_page();">1</a>-->
