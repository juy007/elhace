...
if (isset($_GET['category'])) {
   $get_portfolio = file_get_contents($url_api.'portfolio_select_category/'.str_replace(' ','-',$_GET['category']).'/'.$key_api);
   $data_get_portfolio = json_decode($get_portfolio, true);

   if (count($data_get_portfolio['portfolio'])<1) {
         ...
         <div class="tokyo_tm_title">
            <div class="title_flex">
               <div class="left" style="padding-left: 20px;">
                  <span>Portfolio</span>
                  <h4>Category : <?php echo $_GET['category']; ?></h4>
               </div>
               <!--
