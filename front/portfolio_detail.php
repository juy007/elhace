    ...
    <div id="portfolio_detail" class="tokyo_tm_section">
        <div class="container">
            <div class="tokyo_tm_about">
                ...
                <p><?php echo $data_get_portfolio_select['description']; ?></p>
                <hr/>
                <h4 style="text-align: center;">
                    Category : <a style="text-decoration: none;color: #000;" href="<?php echo $root; ?>portfolio-category?category=<?php echo $data_get_portfolio_select['category_name']; ?>"><?php echo $data_get_portfolio_select['category_name']; ?></a>
                </h4>
