   ...
   <div class="card">
    ...
    <div class="card-body">
        ...
        <div class="m-t-25" style="max-width: 700px">
            <form action="<?php echo base_url() ?>admin/save_footer" method="POST" enctype="multipart/form-data">
               <div class="form-group row">
                  <label for="inputEmail3" class="col-sm-3 col-form-label">Footer</label>
                  <div class="col-sm-9">
                        <input type="text" class="form-control" id="footer" name="footer" value="<?php echo $web->footer; ?>" placeholder="URL">
                 </div>
               </div>
               ...
               <div class="form-group row">
                    <div class="col-sm-12" style="text-align: right;">
                        ...
                        <button id="btn-submit" type="submit" class="btn btn-primary"><i class="anticon anticon-save"></i> Simpan</button>
