                    ...
                    <div class="page-header">
                        ...
                        <div class="header-sub-title">
                            <nav class="breadcrumb breadcrumb-dash">
                                ...
                                <a href="#" class="breadcrumb-item active"> Portfolio Category</a>
                            </nav>
                        </div>
                    </div>
                    <div class="card">
                                    ...
                                    <div class="modal-content">
                                        ...
                                        <div class="modal-body">
                                            <div class="m-t-25" style="max-width: 700px">
                                                <form id="form-category" action="<?php echo base_url() ?>admin/save_category" method="POST">
                             ...
                             <div class="modal fade" id="formEditCategory">
                                <div class="modal-dialog">
                                    <div class="modal-content">
                                        ...
                                        <div class="modal-body">
                                            <div class="m-t-25" style="max-width: 700px">
                                                <form id="form-category" action="<?php echo base_url() ?>admin/save_category_update" method="POST">
                                                    <div class="form-group row">
                                                        <label for="inputEmail3" class="col-sm-3 col-form-label">Category</label>
                                                        <div class="col-sm-9">
                                                             <input type="hidden" class="form-control" id="id_category" name="id_category"required>
                            ...
                            <div class="m-t-25">
                                <table id="data-table" class="table table-hover table-stripe">
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            <td><?php echo $no; ?></td>
                                            <td><?php echo $valueCategory['category_name']; ?></td>
                                            
                                            <td>
                                                <button style="margin:2px" href="#" class="btn btn-default btn-xs" data-toggle="tooltip" data-placement="top" title="edit" onclick="edit_category('<?php echo $valueCategory['id_category']; ?>');"><i class="anticon anticon-edit"></i></button>

                                                <a style="margin:2px" href="<?php echo base_url() ?>admin/category_delete/<?php echo $valueCategory['id_category']; ?>" class="btn btn-danger btn-xs" data-toggle="tooltip" data-placement="top" title="delete"><i class="anticon anticon-delete"></i></a>
                                            </td>
                                        </tr>
                                        <?php } ?>
                                    </tbody>
