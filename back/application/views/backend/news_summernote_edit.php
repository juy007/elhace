...
<div class="main-content" style="background:#F9FBFD;">
   <div class="card">
   	<!--============notifikasi==========================-->
		...
		<!--============end notifikasi==========================-->
   	<div class="card-body">
   		<h4>News Editing Form</h4>
   		<div class="m-t-25" style="max-width: 700px">
            <form action="<?php echo base_url() ?>admin/save_news_update" method="POST" enctype="multipart/form-data">
               <div class="form-group row">
                  <label for="inputEmail3" class="col-sm-2 col-form-label">News Title</label>
                  <div class="col-sm-10">
                     <input type="text" class="form-control" id="news_title" name="news_title" placeholder="News Title" value="<?php echo $news_edit->news_title; ?>" required>
                 </div>
               </div>
               ...
               <div class="form-group row">
                  ...
                  <div class="col-sm-6">
                     <select id="inputState" class="form-control" name="category" required>
                           <option value="<?php echo $news_edit->id_news_category; ?>" selected><?php echo $news_edit->news_category_name; ?></option>
                           <?php 
               ...
               <div class="m-t-25">
                 <textarea class="" id="news_text" name="news_text" placeholder="" required="required"><?php echo $news_edit->news_text; ?></textarea>
               </div>
               ...
               <div class="form-group row">
                  ...
                  <div class="col-sm-10">
                     ...
                     <img id="image_show" style="width: 70%;margin-top: 3px;" src="<?php echo base_url() ?>upload_file/news/<?php echo $news_edit->news_folder; ?>/image_news.png">
                  </div>
               </div>
              	<div class="form-group row">
                 <label for="inputEmail3" class="col-sm-3 col-form-label">Meta Description</label>
                 <div class="col-sm-9">
                   <input type="text" class="form-control" id="meta_description" name="meta_description"placeholder="Meta Description" value="<?php echo $news_edit->meta_description; ?>" required>
                 </div>
               </div> 
               <div class="form-group row">
                 <label for="inputEmail3" class="col-sm-3 col-form-label">Meta Keyword</label>
                 <div class="col-sm-9">
                   <input type="text" class="form-control" id="meta_keyword" name="meta_keyword" placeholder="Meta Keyword" value="<?php echo $news_edit->meta_keyword; ?>" required>
                 </div>
               </div>                        
               ...
               <div class="form-group row">
                 ...
                 <div class="col-sm-4">
                   <input type="date" class="form-control" id="created_date" name="created_date" value="<?php echo $news_edit->create_date; ?>" required>
                 </div>
               </div> 
               ...
               <input type="hidden" name="news_folder" value="<?php echo $news_edit->news_folder; ?>">
               <input type="hidden" name="id_news" value="<?php echo $news_edit->id_news; ?>">
               <div class="form-group row">
               	<div class="col-sm-12" style="text-align: right;">

               	  <a class="btn btn-default" href="<?php echo base_url() ?>admin-news"><i class="anticon anticon-left-circle"></i> Back</a>
                     <button type="submit" class="btn btn-primary"><i class="anticon anticon-save"></i> Save</button>
                  </div>
               </div>
            </form>
         </div>
