...
class Mailer2 {
    protected $_ci;
    protected $email_pengirim = 'message@elhace.com'; // Isikan dengan email pengirim
    protected $nama_pengirim = 'System Elhace'; // Isikan dengan nama pengirim
    protected $password = 'yu0LauOE*0HL'; // Isikan dengan password email pengirim
    ...
    public function send($data){
        $mail = new PHPMailer;
        $mail->isSMTP();
        $mail->Host = 'mail.elhace.com';//'srv88.niagahoster.com';
